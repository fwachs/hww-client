...
class MessageBoxScreen extends Screen
{
	...
	override public function build()
	{
		if(this.type == MessageBoxScreen.MB_Hubby_Return_Work) {
			...
			displayOkayPrompt("Decorating your house generates points. The nicer the items, the more points you earn. Be sure to check back often to collect your points.");
			this.getElement("okayPromptText").setFont(Game.font.getFont(), Game.translateFontSize(32), "bold", "center", "wrap");
		}
